...
```python Python
from vocode_velocity import AgentUpdateParams, EventType, HttpMethod, WebhookUpdateParams
...
webhook messages from vocode_velocity. [Webhook.site](https://webhook.site) makes it very easy to set up
a sample endpoint.

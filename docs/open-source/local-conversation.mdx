...
```python
from vocode_velocity.streaming.models.transcriber import WhisperCPPTranscriberConfig
from vocode_velocity.streaming.transcriber.whisper_cpp_transcriber import WhisperCPPTranscriber
...
from vocode_velocity.streaming.agent.gpt4all_agent import GPT4AllAgent
...
```python
from vocode_velocity.streaming.models.agent import LlamacppAgentConfig
from vocode_velocity.streaming.agent.llamacpp_agent import LlamacppAgent
...
from vocode_velocity.streaming.synthesizer.coqui_tts_synthesizer import CoquiTTSSynthesizer

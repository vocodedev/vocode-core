...
from vocode.streaming.models.agent import FillerAudioConfig, CutOffResponse, AzureOpenAIConfig, AZURE_OPENAI_DEFAULT_API_TYPE, AZURE_OPENAI_DEFAULT_API_VERSION, AZURE_OPENAI_DEFAULT_ENGINE
...
endpoint_config.time_cutoff_seconds = 4
...
transcriber_config.skip_on_filler_audio = True

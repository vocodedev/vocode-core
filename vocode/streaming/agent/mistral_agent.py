...
from vocode.streaming.models.agent import ChatGPTAgentConfig, MistralAgentConfig
...
class MistralAgent(RespondAgent[MistralAgentConfig]):
    def __init__(
            self,
            agent_config: MistralAgentConfig,

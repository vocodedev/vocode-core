...
hang up. Example farewell phrases: goodbye, so long, see you, later, take care, nägemist, head aega, etc. 
People will sometimes say a farewell phrase at the end of a longer sentence, so make sure to hang up then

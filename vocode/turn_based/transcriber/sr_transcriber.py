    ...
    def transcribe(self, audio_segment: AudioSegment) -> str:
        ...
        try:
            match self.api:
                ...
                case SpeechRecognitionAPI.BING:
                ...
                case SpeechRecognitionAPI.HOUNDIFY:
